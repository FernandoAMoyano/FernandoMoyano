...
export default function Footer() {
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/fernando-moyano/',
      color: '#0A66C2',
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/FernandoAMoyano',
      color: '#333',
    ...
    {
      name: 'WhatsApp',
      url: 'https://wa.me/543517442112?text=Hola%20Fernando%2C%20vi%20tu%20portfolio%20y%20me%20gustar%C3%ADa%20contactarte',
      color: '#25D366',
  ...
  return (
    <footer className={styles.footer}>
      <p className={styles.copyright}>
        © 2024 Fernando Moyano. Todos los derechos reservados.
      </p>
